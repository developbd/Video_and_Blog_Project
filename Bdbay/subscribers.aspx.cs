    ...
    public partial class subscribers : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["UserID"] != null)
            {
                ...
                cmd.CommandText = "select * from Subscribe where SubscribeID='" + UserID + "'";
                video_Conf.Open();
                SqlDataReader data = cmd.ExecuteReader();
                while (data.Read())
                {
                    string subscribeID = data["UserID"].ToString();
                    ...
                    subscribeShow.Controls.Add(new LiteralControl(@"<div class='large-2 small-6 medium-3 columns'><div class='follower'><div class='follower-img'><a href = '" + link + "' ><img src='" + Image + "' alt='followers'></a></div><a href='" + link + "' ><span >" + Name + "</span></a></div></div>"));
