<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="footer.ascx.cs" Inherits="Bdbay.footer" %>
                    ...
                    <div class="large-3 medium-6 columns">
                        <div class="widgetBox">
                            ...
                            <div class="textwidget">
                                BDbay video wordpress theme lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s book.
                            </div>
                        </div>
                    </div>
                    <div class="large-3 medium-6 columns">
