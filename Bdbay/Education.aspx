<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Education.aspx.cs" Inherits="Bdbay.Education" %>
                                        ...
                                        <div class="widgetContent">
                                            <ul class="accordion" data-accordion>
                                                <li class="accordion-item is-active" data-accordion-item>
                                                    <a href="#" class="accordion-title">BCS</a>
                                                    <div class="accordion-content" data-tab-content>
                                                       <ul>
                                                           <li class="clearfix">
                                                               <i class="fa fa-play-circle-o"></i>
                                                               <a href="#">Bangla <span>(10)</span></a>
                                                           </li>
                                                           <li>
                                                               <i class="fa fa-play-circle-o"></i>
                                                               <a href="#">English <span>(3)</span></a>
                                                           </li>
                                                           <li>
                                                               <i class="fa fa-play-circle-o"></i>
                                                               <a href="#">Math <span>(6)</span></a>
                                                           </li>
                                                           <li>
                                                               <i class="fa fa-play-circle-o"></i>
                                                               <a href="#">Computer <span>(8)</span></a>
                                                           </li>
                                                           <li>
                                                               <i class="fa fa-play-circle-o"></i>
                                                               <a href="#">Science <span>(10)</span></a>
                                                           </li>
                                                           <li>
                                                               <i class="fa fa-play-circle-o"></i>
                                                               <a href="#">other <span>(5)</span></a>
                                                           </li>
                                                       </ul>
                                                    </div>
                                                </li>
                                                <li class="accordion-item" data-accordion-item>
                                                    <a href="#" class="accordion-title">SSC</a>
                                                    <div class="accordion-content" data-tab-content>
                                                        <ul>
                                                            <li class="clearfix">
                                                                <i class="fa fa-play-circle-o"></i>
                                                ...
                                                <li class="accordion-item" data-accordion-item>
                                                    <a href="#" class="accordion-title">Class 8</a>
                                                    <div class="accordion-content" data-tab-content>
                                                        <ul>
                                                            <li class="clearfix">
                                                                <i class="fa fa-play-circle-o"></i>
                                                 ...
                                                 <li class="accordion-item" data-accordion-item>
                                                    <a href="#" class="accordion-title">Class 7</a>
                                                    <div class="accordion-content" data-tab-content>
                                                        <ul>
                                                            <li class="clearfix">
                                                                <i class="fa fa-play-circle-o"></i>
                                                 ...
                                                 <li class="accordion-item" data-accordion-item>
                                                    <a href="#" class="accordion-title">Class 6</a>
                                                    <div class="accordion-content" data-tab-content>
                                                        <ul>
                                                            <li class="clearfix">
                                                                <i class="fa fa-play-circle-o"></i>
                                                ...
                                                <li class="accordion-item" data-accordion-item>
                                                    <a href="#" class="accordion-title">Class 5</a>
                                                    <div class="accordion-content" data-tab-content>
                                                        <ul>
                                                            <li class="clearfix">
                                                                <i class="fa fa-play-circle-o"></i>
                                                 ...
                                                 <li class="accordion-item" data-accordion-item>
                                                    <a href="#" class="accordion-title">Class 4</a>
                                                    <div class="accordion-content" data-tab-content>
                                                        <ul>
                                                            <li class="clearfix">
                                                                <i class="fa fa-play-circle-o"></i>
